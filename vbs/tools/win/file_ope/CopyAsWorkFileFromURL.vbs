...
sDownloadFileUrl = InputBox( "ダウンロードしたいファイルを入力してください", sPROG_NAME, sIniDownloadFileUrl )
...
Dim sDownloadSrcUrl
sDownloadSrcUrl = InputBox( "ダウンロードしたいファイルを入力してください", sPROG_NAME, sIniDownloadSrcUrl )
