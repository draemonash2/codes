...
' = 依存    FileSystem.vbs/GetFileNotExistPath()
' =         FileSystem.vbs/GetFolderNotExistPath()
' = 所属    FileSystem.vbs
' ==================================================================
...
' = 引数    sTrgtDirPath    String      [in]    対象パス
' = 戻値                    String              付与後パス
' = 覚書    本関数では、フォルダは作成しない。
' = 依存    なし
' = 所属    FileSystem.vbs
' ==================================================================
Public Function GetFolderNotExistPath( _
...
' = 依存    FileSystem.vbs/SetDialogFilters()
' = 所属    FileSystem.vbs
' ==================================================================
