...
' =         最前面へ移動                                最前面へ移動する
' =         最背面へ移動                                最背面へ移動する
' =         シート内オブジェクトサイズ変更プロパティ一括変更    現在シートの全オブジェクトを
' =                                                             「セルに合わせて移動とサイズ変更をする」に変更
' =         ブック内オブジェクトサイズ変更プロパティ一括変更    現在ブックの全オブジェクトを
' =                                                             「セルに合わせて移動とサイズ変更をする」に変更
' =============================================================================
...
' = 所属    Macros.bas
' =============================================================================
Public Sub シート内オブジェクトサイズ変更プロパティ一括変更()
    Dim objShp As Shape
...
' = 所属    Macros.bas
' =============================================================================
Public Sub ブック内オブジェクトサイズ変更プロパティ一括変更()
    Dim objShp As Shape
    Dim objSheet As Worksheet
    For Each objSheet In ThisWorkbook.Worksheets
        For Each objShp In objSheet.Shapes
            objShp.Placement = xlMoveAndSize
        Next
    Next
    MsgBox "アクティブブック内の全オブジェクトのプロパティを、" & vbNewLine & _
        "「セルに合わせて移動とサイズ変更をする」に一括変更しました！"
End Sub
