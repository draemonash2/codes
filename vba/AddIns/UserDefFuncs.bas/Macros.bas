...
' =============================================================================
' =  <<マクロ一覧>>
' =    ・CenterAcrossForSelectionCell 選択セルに対して「選択範囲内で中央」を実行する
' =    ・DecrementNum                 ②～⑮を指定して、指定番号以降をインクリメントする
' =    ・IncrementNum                 ①～⑭を指定して、指定番号以降をデクリメントする
' =    ・CopySheetNames               ブック内のシート名を全てコピーする
' =    ・StartSheetVisibleSetting     シート表示/非表示を切り替える
' =    ・CopyWithoutDblQuote          ダブルクオーテーションなしでセルコピーする
' =    ・TreeGroup                    ツリーグループ化する
' =    ・SortSheetPre                 シート並べ替え作業用シート作成
' =    ・OpenSelectedHPLinks          選択した範囲のハイパーリンクを一括で開く
' =============================================================================

'******************************************************************************
'* 定数定義
'******************************************************************************
'=== 以下、DecrementNum/IncrementNum 用定義 ===
Const NUM_MAX = 15
Const NUM_MIN = 1
...
' =============================================================================
Public Sub CenterAcrossForSelectionCell()
...
' = 概要：シート表示/非表示を切り替える
' =============================================================================
Public Sub StartSheetVisibleSetting()
...
' =============================================================================
Public Sub CopyWithoutDblQuote()
    Dim sBuf As String
    Dim lSelCnt As Long
...
' =============================================================================
' = 概要：行をツリー構造にしてグループ化
' = Usage：ツリーグループ化したい範囲を選択し、マクロ「TreeGroup」を実行する
' =============================================================================
Public Sub TreeGroup()
...
' =============================================================================
Public Sub OpenSelectedHPLinks()
    Dim Rng As Range
