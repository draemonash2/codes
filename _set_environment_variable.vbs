...
Const sENV_TARGET = "System"    'System:ƒVƒXƒeƒ€ŠÂ‹«•Ï” User:ƒ†[ƒUŠÂ‹«•Ï”
                                                                                                            ' +------+------+------+------------+--------------+
...
With dEnvVars                                                                                               ' +------+------+------+------------+--------------+
    ...
    .Add "MYDIRPATH_PROGRAMS"       ,"C:\programs"                                                          ' |  |  |  |  |  |  |     |     |      |      |
    ...
    .Add "MYEXEPATH_CCALC"          ,"%MYDIRPATH_PRG_EXE%\cCalc\cCalc.exe"                                  ' |  |  |  Z  |  |  |     |     |      |      |
...
With objWshShell.Environment(sENV_TARGET)
    ...
    If lEXEC_MODE = 1 Then
        ...
        Next
        Msgbox "ŠÂ‹«•Ï”‚ð’Ç‰Á‚µ‚Ü‚µ‚½"
    ElseIf lEXEC_MODE = 2 Then
        For Each vKey In dEnvVars
            .Remove(vKey)
        Next
        Msgbox "ŠÂ‹«•Ï”‚ðíœ‚µ‚Ü‚µ‚½"
    Else
        Msgbox "lEXEC_MODEƒGƒ‰[I"
    End If
End With
