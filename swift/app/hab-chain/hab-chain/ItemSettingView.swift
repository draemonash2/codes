                    ...
                    ForEach(hab_chain_data.item_id_list, id: \.self) { item_id in
                        if let unwraped_item = hab_chain_data.items[item_id] {
                            ...
                            .swipeActions(edge: .trailing){
                                Button {
                                    print("pressed delete \(unwraped_item.item_name) item")
                                ...
                                .tint(.red)
                                Button {
                                    print("pressed copy \(unwraped_item.item_name) item")
                                    hab_chain_data.copyItem(item_id: item_id)
                                } label : {
