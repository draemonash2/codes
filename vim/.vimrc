...
"	nnoremap	<silent>			<c-s-tab>	gT|												" タブ切替（前へ）
	...
	nnoremap	<silent>			<a-h>		<c-w>h|											" ウィンドウフォーカス移動(左)
	nnoremap	<silent>			<a-j>		<c-w>j|											" ウィンドウフォーカス移動(下)
	nnoremap	<silent>			<a-k>		<c-w>k|											" ウィンドウフォーカス移動(上)
	nnoremap	<silent>			<a-l>		<c-w>l|											" ウィンドウフォーカス移動(右)
